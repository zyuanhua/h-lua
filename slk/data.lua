...
obj.Ubertip =
    "如果物品|cffffff80多个叠加|r，会先被拆分成多个|cffffff80单品|r|n当单品是一个|cffffff80合成物|r时，将被拆分成|cffffff80相应的零件|r|n|cffff8080 * 注意拆分后的物品如果持有会掉落在地上，做好心理准备|r"
...
local envs = {
    ...
    {
        Name = "burn_build",
        file = "Doodads\\Cityscape\\Structures\\CityBuildingLarge_0_BaseRuin\\CityBuildingLarge_0_BaseRuin.mdl"
    }, --焚烧毁坏建筑
